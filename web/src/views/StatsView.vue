  ...
  <div v-if="stats">
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
      <div class="rounded-2xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-900">
        <Clock3 class="mb-2 text-accent dark:text-accent-soft" :size="22" />
      ...
      <div class="rounded-2xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-900">
        <BookCheck class="mb-2 text-accent dark:text-accent-soft" :size="22" />
      ...
      <div class="rounded-2xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-900">
        <Flame class="mb-2 text-accent dark:text-accent-soft" :size="22" />
    ...
    <div class="flex h-32 items-end gap-1.5">
      <div v-for="d in last14" :key="d.day" class="flex flex-1 flex-col items-center gap-1">
        <div
          class="w-full rounded-t bg-accent-bar dark:bg-accent-bar-dark"
